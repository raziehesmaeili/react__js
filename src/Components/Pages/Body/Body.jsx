...
const Body = () => {
  ...
  const fetchImages = async () => {
    try {
      const response = await fetch("http://localhost:3004/body");
      if (!response.ok) {
  ...
  return (
    <div style={{ direction: "rtl" }}>
      ...
      <div style={{ direction: 'rtl' }}>
        <p><span style={{ color: '#adb5bd', marginRight: "150px" }}>خانه </span>/ محصولات بدن</p>
      </div>
          ...
          <div key={elem.id} style={{ marginBottom: "20px" }}>
            ...
            >
              ...
              <div style={{
                ...
                >
                  <IoSearchOutline size={20} onClick={() => navigate(`/محصولات بدن/${elem.title}`)} style={{ marginTop: "3px" }} />
                </div>
              </div>
            </Card>
          </div>
