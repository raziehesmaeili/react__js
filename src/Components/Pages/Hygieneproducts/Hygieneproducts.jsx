...
const HygieneProducts = () => {
  ...
  const fetchImages = async () => {
    try {
      const response = await fetch("http://localhost:3004/Hygieneproducts");
      if (!response.ok) {
  ...
  return (
    <div style={{ direction: "rtl" }}>
      ...
      <div style={{ direction: 'rtl' }}>
        <p><span style={{ color: '#adb5bd', marginRight: "150px" }}>خانه </span>/  محصولات بهداشتی</p>
      </div>
          ...
          <div key={elem.id} style={{ marginBottom: "20px" }}>
            ...
            >
              ...
              <div style={{
                ...
                >
                  <IoSearchOutline size={20} onClick={() => navigate(`/محصولات پوستی/${elem.title}`)} style={{ marginTop: "3px" }} />
                </div>
              </div>
            </Card>
          </div>
