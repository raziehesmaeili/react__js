...
const Cosmetics = () => {
    ...
    return (
        <div style={{ direction: "rtl" }}>
            ...
            <div style={{ direction: 'rtl' }}>
                <p><span style={{ color: '#adb5bd', marginRight: "150px" }}>خانه </span>/   لوازم آرایشی</p>
            </div>
                    ...
                    <div key={elem.id} style={{ marginBottom: "20px" }}>
                        ...
                        >
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>
                                    <div className='d-flex mx-auto' style={{ direction: "rtl", marginRight: "35px", textAlign: "center" }}>
                            ...
                            <div style={{
                                ...
                                >
                                    <IoSearchOutline size={20} onClick={() => navigate(`/لوازم آرایشی/${elem.title}`)} style={{ marginTop: "3px" }} />
                                </div>
                            </div>
                        </Card>
                    </div>
