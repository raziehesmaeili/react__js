...
const Boosters = () => {
  ...
  return (
    <div style={{ direction: "rtl" }}>
      ...
      <div style={{ direction: 'rtl' }}>
        <p><span style={{ color: '#adb5bd', marginRight: "150px" }}>خانه </span>/ تقویت کننده ها</p>
      </div>
          ...
          <div key={elem.id} style={{ marginBottom: "20px" }}>
            ...
            >
              ...
              <div style={{
                ...
                >
                  <IoSearchOutline size={20} onClick={() => navigate(`/تقویت کننده ها/${elem.title}`)} style={{ marginTop: "3px" }} />
                </div>
              </div>
            </Card>
          </div>
